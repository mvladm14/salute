 ...
 */
public class BandUtil implements AsyncResponse {
    ...
    public BandUtil(Context context) {
    ...
    public SensorRegistrationManager getSensorRegistrationManager() {
        return sensorRegistrationManager;
    }
